        ...
        <ul className="navbar-links">
          ...
          {effectiveMode !== "shop" && (
            <>
              ...
              <li><Link to="/coach-ai" className="navbar-link-box">Coach AI</Link></li>
        ...
        <ul className="mobile-menu-links">
          ...
          {effectiveMode !== "shop" && (
            <>
              ...
              <li><Link to="/coach-ai" onClick={() => setMobileMenuOpen(false)} className="mobile-menu-item">Coach AI</Link></li>
